...
CASES = [
    ...
    {
        "query": "the tariff law the administration is invoking",
        "type": "topic_paraphrase",
        "phrase": "section 122",
    },
    {
        "query": "the missile defense shield Trump announced",
        "type": "topic_paraphrase",
        "phrase": "golden dome",
    },
    {
        "query": "officials leaked military strike plans in a group chat",
        "type": "topic_paraphrase",
        "phrase": "signal chat",
    },
    {
        "query": "Trump comparing himself to a boxer, the madman strategy",
        "type": "topic_paraphrase",
        "phrase": "mike tyson",
    },
    {
        "query": "the US trying to take over the Panama Canal",
        "type": "topic_paraphrase",
        "phrase": "panama canal",
    },
    # number paraphrase — exercises digit->word normalization
    {
        "query": "Trump gave Iran 2 or 3 days to make a deal",
        "type": "number_paraphrase",
        "phrase": "two or three days",
    },
    # coined phrase — a known-hard, idiosyncratic target
    {
        "query": "Trump conflict handling pattern day 2 day 4",
        "type": "coined_phrase",
        "phrase": "day two of the cycle",
    },
    ...
    {
        "query": "Mike Waltz national security adviser",
        "type": "specific_term",
        "phrase": "mike waltz",
    },
    {
        "query": "Alligator Alcatraz detention facility",
        "type": "specific_term",
        "phrase": "alligator alcatraz",
    },
    {"query": "Kash Patel at the FBI", "type": "specific_term", "phrase": "kash patel"},
    {
        "query": "the madman theory of negotiation",
        "type": "specific_term",
        "phrase": "madman theory",
    },
    ...
    {
        "query": "Yemeni rebels attacking Red Sea shipping",
        "type": "topic_paraphrase",
        "phrase": "houthis",
    },
    {
        "query": "the immigration detention camp in the Florida Everglades",
        "type": "topic_paraphrase",
        "phrase": "alligator alcatraz",
    },
    {
        "query": "mass nationwide street protests against Trump",
        "type": "topic_paraphrase",
        "phrase": "no kings",
    },
    {
        "query": "Musk's government cost-cutting task force",
        "type": "topic_paraphrase",
        "phrase": "doge",
    },
    {
        "query": "ending automatic citizenship for US-born children of immigrants",
        "type": "topic_paraphrase",
        "phrase": "birthright citizenship",
    },
    {
        "query": "the new FBI director Trump appointed",
        "type": "topic_paraphrase",
        "phrase": "kash patel",
    },
    {
        "query": "the Ukrainian president's tense White House meeting",
        "type": "topic_paraphrase",
        "phrase": "volodymyr zelensky",
    },
    ...
    {
        "query": "birthright citizenship executive order",
        "type": "multi_episode",
        "phrase": "birthright citizenship",
    },
]
...
def evaluate_corpus(corpus, embed=None, cases=CASES, ks=(5, 10)) -> dict:
    ...
    return evaluate(
        _hybrid_retriever(corpus, embed),
        got["documents"],
        got["metadatas"],
        cases=cases,
        ks=ks,
...
def format_single(name: str, res: dict, ks=(5, 10)) -> str:
    ...
    o = res["overall"]
    lines = ["=== OVERALL ===", "retriever  " + "  ".join(f"recall@{k}" for k in ks) + "   MRR"]
    cells = "   ".join(f"{o['recall'][k]:.2f}    " for k in ks)
    lines.append(f"{name:14}  {cells}  {o['mrr']:.2f}  (n={o['n']})")
    lines.append(f"\n=== recall@{ks[-1]:d} by query type ===")
...
def format_report(comparison: dict, ks=(5, 10)) -> str:
    ...
    lines.append(f"\n=== recall@{ks[-1]:d} by query type (semantic -> hybrid) ===")
    for t in types:
